...
1	autoresearch/2026-05-20-dapo-qwen2p5/baseline	abc0000	abc1234	examples/configs/recipes/llm/dapo-qwen2.5-0.5b-b512-p512-g16-fp16.yaml	val_accuracy	0.000000	0.0	12.4	local	none	uv run ./examples/run_grpo.py --config examples/configs/recipes/llm/dapo-qwen2.5-0.5b-b512-p512-g16-fp16.yaml	reports/auto_research/2026-05-20-dapo-qwen2p5/baseline/run.log	crash	baseline failed before training
2	autoresearch/2026-05-20-dapo-qwen2p5/prompt-compact-schema	abc1234	def5678	examples/configs/recipes/llm/dapo-qwen2.5-0.5b-b512-p512-g16-fp16.yaml	val_accuracy	0.742100	43.9	58.7	local	none	uv run ./examples/run_grpo.py --config examples/configs/recipes/llm/dapo-qwen2.5-0.5b-b512-p512-g16-fp16.yaml	reports/auto_research/2026-05-20-dapo-qwen2p5/prompt-compact-schema/run.log	keep	compact answer schema
3	autoresearch/2026-05-20-dapo-qwen2p5/rollout-batch-up	abc1234	fedcba9	examples/configs/recipes/llm/dapo-qwen2.5-0.5b-b512-p512-g16-fp16.yaml	val_accuracy	0.751200	44.1	59.8	local	none	uv run ./examples/run_grpo.py --config examples/configs/recipes/llm/dapo-qwen2.5-0.5b-b512-p512-g16-fp16.yaml	reports/auto_research/2026-05-20-dapo-qwen2p5/rollout-batch-up/run.log	discard	raise rollout batch size without prompt changes
```
